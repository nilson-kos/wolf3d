...
/*   Updated: 2017/03/25 15:46:23 by kshcherb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	action(t_wf *wf)
{
	if (ft_chmo(wf, (int)(wf->game.posy + wf->game.diry),
		(int)(wf->game.posx + wf->game.dirx)) == '5')
		wf->lvl1[(int)(wf->game.posy + wf->game.diry)]
				[(int)(wf->game.posx + wf->game.dirx)] = '0';
	else if (ft_chmo(wf, (int)(wf->game.posy + wf->game.diry),
		(int)(wf->game.posx + wf->game.dirx)) == '0')
		wf->lvl1[(int)(wf->game.posy + wf->game.diry)]
				[(int)(wf->game.posx + wf->game.dirx)] = '5';
	else if (ft_chmo(wf, (int)(wf->game.posy + wf->game.diry),
		(int)(wf->game.posx + wf->game.dirx)) == '4')
		wf->flmenu.menu = 3;
}
